...
<div class="col-xs-12">
    ...
    margin-left: 0px;" align="center">
                    ...
                    <hr>
                    <form id="signup-form" class="row col-xs-11 col-xs-pull-1 col-xs-push-1" action="/web_big_homework/login" method="post">
                        <fieldset>
                            <div class="form-group">
                                <span id="login_tishi">${message1}</span><br>
                                <label>学号/工号</label>
                                <div style="position: relative">
                                    <i class="fas fa-envelope icon fa-lg" style="line-height: 100%;"></i>
                                    <input id="id" name="id" type="text" class="form-control border" placeholder="请输入您的学号/工号" autocomplete="off" required="" aria-required="true" autofocus="" value="<%=UserId%>">
                                </div>
                            </div>
                            ...
                            <button type="submit" class="text-center" style="width:100%; height: 40px; border: none; background-color: #36AAFD; color: white;margin-top:17px">
                                登陆                            </button>
							<p class="text-center" style="color: #8C8C8C; margin-top: 20px"><input type="checkbox" id="chk11" name="remember_me">记住我&nbsp;&nbsp;&nbsp;&nbsp;<a href="/web_big_homework/find.jsp">忘记密码</a>&nbsp;&nbsp;&nbsp;&nbsp;
