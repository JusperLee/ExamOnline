    ...
    <body>
    	<div class="main" style="width:100%">
    		<table class="t" border="1px solid" cellspacing="0"  style="width:100%">
    	  	...
    	  	<tr  style="text-align:center;">
    	  		<td><font style="font-family:small arial,sans-serif;font-size:23px">${j.papername}</font></td>
    	  		<td><font style="font-family:small arial,sans-serif;font-size:23px">${j.starttime}</font></td>
    	  		<td><font style="font-family:small arial,sans-serif;font-size:23px">${j.endtime}</font></td>
    	  		<td><font style="font-family:small arial,sans-serif;font-size:23px">${j.class1}</font></td>
    	  	</tr>
    	  	</c:forEach>
    	  </table>
    	  </div>
