...
<html>
    ...
    <body>
    	<div id="div1" style="width:100%">
    		<form action="../InsertQuestion?questiontype=xztbatch" method="post"enctype="">
    		<table id="tab1" style="margin:0 auto;width:50%">
    			<tr>
    				<td colspan="2" style="text-align: center;width:45%">填空题</td>
    			</tr>
    			<tr>
    				<td class="tkchoose" >知识点</td>
    				<td >
    					<input type="text"  name="questionpoint" id="tktitle" placeholder="请输入题目"/>	
    				</td>
    			</tr>
    			<tr>
