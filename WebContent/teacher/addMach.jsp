    ...
    <body>
    	<div id="div1" style="width:100%">
    		...
    		<form action="../InsertQuestion?questiontype=xztbatch" method="post" enctype="multipart/form-data">
    			...
    			<form action="../InsertQuestion?questiontype=pdtbatch" method="post" enctype="multipart/form-data">
    			<tr>
    				<td class="xz">简答题</td>
    				<td class="file">
    					<input type="file" value="" name="f1"/>
    				...
    				<form action="../InsertQuestion?questiontype=jdtbatch" method="post" enctype="multipart/form-data">
    			<tr>
    				<td class="xz">编程题</td>
    				<td >
