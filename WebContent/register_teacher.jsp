    ...
    <div class="row">
        <div class="col-xs-12">
            <div class="form-warpper" style="width:580px">
                <div id="form-box" class="border" style="height: 950px">
                    <div class="col-xs-offset-1 title-align" style="
    margin-left: 0px;" align="center">
                        <h3><img src="./image/name.png"></img></h3>
                    </div>
                    <hr>
                    <form id="signup-form" class="row col-xs-11 col-xs-pull-1 col-xs-push-1" action="/web_big_homework/teacher_regist" method="post">
                        <fieldset>
                            ...
                            <div class="form-group">
                                ...
                                <div style="position: relative">
                                    ...
                                    <input id="num" name="num" type="text" class="form-control border" placeholder="请输入正确授权码" maxlength="99" autocomplete="off" required="" aria-required="true">
                                </div>
                            </div>
                            <div class="form-group">
                                <label>密码</label>
                            ...
                            <div class="form-group">
                                ...
                                <div style="position: relative">
                                    <i class="fas fa-mobile icon fa-lg" style="line-height: 100%;"></i>
                                    <input id="auth" name="auth" type="text" class="form-control border" placeholder="请输入正确授权码" maxlength="99" autocomplete="off" required="" aria-required="true">
                                </div>
                            </div>
							<div class="form-group">
                                <label>手机号</label>
